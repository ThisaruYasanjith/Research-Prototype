export class HtmlTemplates {
  private static getSharedStyles(): string {
    return `
      body {
  ...
  public static getAnalysisHtml(targetFile: string): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="file-target">${targetFile}</div>
...
try {
  ...
  <div class="section-card">
    ...
    <div style="font-size: 11px; font-weight: 600; color: var(--vscode-descriptionForeground);">Exception flow:</div>
    <div class="code-block">loadFile()
    ↓
IOException
    ↓
try block
...
handler</div>
  ...
  public static getNotFoundHtml(): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  <div class="empty-state">
    <div class="icon codicon codicon-warning"></div>
    <h3>No FileProcessor.java Detected</h3>
    <p>Please open or focus <code>FileProcessor.java</code> in an editor tab to view its exception analysis.</p>
  </div>
</body>
</html>`;
  }
